...
const colorVariables: ColorVariable[] = [
  ...
  { name: "Primary", cssVar: "--primary", hue: 0, saturation: 0, lightness: 9 },
  {
  ...
  { name: "Muted", cssVar: "--muted", hue: 0, saturation: 0, lightness: 96.1 },
  {
  ...
  { name: "Input", cssVar: "--input", hue: 0, saturation: 0, lightness: 89.8 },
  {
    name: "Destructive",
    cssVar: "--destructive",
    hue: 0,
...
export function CustomThemeEditor() {
  ...
  const applyCustomTheme = () => {
    ...
    Object.entries(colorValues).forEach(([cssVar, { h, s, l }]) => {
      // Format for shadcn/ui: "hue saturation% lightness%" (no commas)
  ...
  return (
    <div className="space-y-4">
      <div className="space-y-2">
        <Label htmlFor="custom-theme-name">Custom Theme Name</Label>
        <Input
      ...
      <div className="space-y-4">
        ...
        {colorVariables.map(({ name, cssVar }) => {
          const hexColor = hslToHex(
            colorValues[cssVar].h,
            colorValues[cssVar].s,
            colorValues[cssVar].l
          );
          return (
            <div
              key={cssVar}
            ...
            >
              ...
              <div className="flex items-center gap-2">
                <div
                  ...
                  style={{
                    backgroundColor: `hsl(${colorValues[cssVar].h} ${colorValues[cssVar].s}% ${colorValues[cssVar].l}%)`,
                  }}
                ></div>
                <Input
                  type="color"
                  ...
                  className="w-8 h-8 p-0 border rounded overflow-hidden"
                />
                <Input
                  type="text"
                  value={hexColor}
